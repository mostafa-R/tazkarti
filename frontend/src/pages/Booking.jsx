...
const Booking = () => {
  ...
  const getTicketDisplayName = () => {
    return selectedTicketData
      ? selectedTicketData.type
      : t("booking.noTicketSelected");
  };
                ...
                <div className="flex-1">
                  ...
                  <div className="space-y-1 text-sm text-gray-600">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span>
                        {eventData.location?.venue || eventData.venue},{" "}
              ...
              {selectedTicketData ? (
                <div className="mb-6">
                  <div className="p-4 rounded-xl border-2 border-blue-500 bg-blue-50">
                    ...
                    {selectedTicketData.features &&
                      selectedTicketData.features.length > 0 && (
                        <div className="text-sm text-gray-600">
                          <p className="font-medium">
                            {t("booking.features")}:
                          </p>
                          <ul className="list-disc list-inside pl-4">
                            {selectedTicketData.features.map(
                              (feature, index) => (
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center justify-center">
                  <span className="text-lg font-semibold bg-gray-100 px-4 py-2 rounded-lg">
                    {quantity}{" "}
                    {quantity === 1
                      ? t("booking.ticketText")
                      : t("booking.ticketsText")}
                  </span>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 sticky top-8">
              ...
              <div className="space-y-3 mb-4">
                <div className="flex justify-between">
                  <span>
                    {getTicketDisplayName()} × {quantity}
                  </span>
                  <span>
                    {subtotal} {getTicketCurrency()}
                  </span>
                </div>
                <div className="flex justify-between text-sm text-gray-600">
                  <span>{t("booking.serviceFee")}</span>
                  <span>
                    {serviceFee} {getTicketCurrency()}
                  </span>
                </div>
