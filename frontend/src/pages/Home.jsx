  ...
  <div className={`min-h-screen bg-gray-50 ${isRTL ? 'font-arabic' : 'font-sans'}`} dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <div className="relative bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-cover bg-center opacity-50" style={{
          backgroundImage: "url('https://images.unsplash.com/photo-1501386761578-eac5c94b800a?w=1200&h=800&fit=crop')"
        }}></div>
            ...
            <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-2xl p-3 flex flex-col md:flex-row gap-3">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className={`w-full py-4 border-0 focus:ring-2 focus:ring-blue-500 focus:outline-none text-gray-900 rounded-xl bg-gray-50 transition-all duration-300 ${isRTL ? 'pr-12 pl-4' : 'pl-12 pr-4'}`}
                  value={searchQuery}
              ...
              <div className="relative min-w-[200px]">
                <select 
                  className={`appearance-none bg-gray-50 border-0 py-4 px-4 focus:ring-2 focus:ring-blue-500 focus:outline-none text-gray-700 cursor-pointer w-full rounded-xl transition-all duration-300 ${isRTL ? 'pr-10 pl-4' : 'pr-10 pl-4'}`}
                ...
                <ChevronDown className={`absolute top-1/2 transform -translate-y-1/2 text-gray-400 h-5 w-5 pointer-events-none ${isRTL ? 'left-3' : 'right-3'}`} />
              </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
          {categories.map((category, index) => {
            ...
            return (
              ...
              >
                <div className={`w-16 h-16 mx-auto mb-4 rounded-2xl ${category.color} flex items-center justify-center transition-all duration-300 shadow-lg group-hover:shadow-xl`}>
          ...
          {loading && (
            <div className="flex justify-center items-center py-20">
              <div className="flex flex-col items-center">
                ...
                <span className="text-lg text-gray-600">{t('events.loading')}</span>
              </div>
            </div>
          )}
          ...
          {error && (
            <div className="text-center py-20">
              <div className="bg-red-50 border-2 border-red-200 rounded-xl p-8 max-w-lg mx-auto">
                ...
                <h3 className="text-xl font-semibold text-red-800 mb-2">{t('error.title')}</h3>
          ...
          {!loading && !error && upcomingEvents.length === 0 && (
            <div className="text-center py-20">
              <div className="bg-gray-50 border-2 border-gray-200 rounded-xl p-12 max-w-lg mx-auto">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">{t('events.emptyTitle')}</h3>
                <p className="text-gray-600 mb-6">{t('events.emptyDescription')}</p>
                <button 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex justify-center space-x-4 mb-8">
              ...
              <div className="w-12 h-12 bg-gray-700 rounded-xl flex items-center justify-center cursor-pointer hover:bg-blue-400 transition-all duration-300 transform hover:scale-110">
