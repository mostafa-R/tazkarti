      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-8 border border-gray-200">
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start text-gray-600">
                  ...
                  <span>{formatEventDate(bookingDetails.event.date)} {t('confirmation.at')} {bookingDetails.event.time}</span>
                </div>
                <div className="flex items-start text-gray-600">
                  <MapPin className="h-5 w-5 mr-3 text-red-500 mt-0.5 flex-shrink-0" />
                  <span>{bookingDetails.event.location.venue}, {bookingDetails.event.location.city}</span>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="space-y-1 text-gray-600">
                    <p>
                      <span className="font-medium">{t('confirmation.ticketType')}:</span> {bookingDetails.ticket.type}
                    </p>
                    <p>
                      <span className="font-medium">{t('confirmation.quantity')}:</span> {bookingDetails.ticket.quantity} {t('confirmation.tickets', { count: bookingDetails.ticket.quantity })}
                    </p>
                    <p>
                      <span className="font-medium">{t('confirmation.totalPrice')}:</span> 
                      <span className="font-bold text-blue-600 ml-1">
                        {bookingDetails.ticket.price} {bookingDetails.ticket.currency}
                      </span>
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-1 text-gray-600">
                    <p>
                      <span className="font-medium">{t('confirmation.customer')}:</span> {bookingDetails.customer.name}
                    </p>
                    <p>
                      <span className="font-medium">{t('confirmation.bookingCode')}:</span> {bookingDetails.customer.bookingCode}
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="w-32 h-32 bg-gray-100 rounded-xl flex items-center justify-center mb-4 relative">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <span className="text-xs text-gray-500">{t('confirmation.qrCode')}</span>
                    </div>
                  </div>
                </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mt-6">
              ...
              <button 
                className="flex-1 bg-gray-100 text-gray-700 py-3 px-4 rounded-lg hover:bg-gray-200 transition-colors flex items-center justify-center font-medium"
              >
        ...
        <div className="mt-12 bg-blue-50 rounded-xl p-6">
          ...
          <div className="space-y-2 text-sm text-blue-800 text-center">
            {t('confirmation.reminders', { returnObjects: true }).map((reminder, index) => (
